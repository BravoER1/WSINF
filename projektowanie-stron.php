<html>
	<head>
		<meta charset='utf-8'>
		<title>Projektowanie Stron - Serce IT</title>
	...
	<div id='kontener'>
		...
		<div id='glowny'>
			<hr>
			<h1>Projektowanie i akutalizacja stron WWW</h1>
			<p>Projektowanie stron internetowych to dla nas nie tylko praca, ale także misja, której celem jest budowanie Twojego profesjonalnego wizerunku w Internecie. Nasi doświadczeni specjaliści stworzą dla Ciebie skuteczną i profesjonalną witrynę. Może to być zarówno projekt niewielkiej strony internetowej, jak i mocno rozbudowany serwis WWW.</p>
			<hr>
		</div>
		<div id='stopka'>
