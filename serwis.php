<html>
	...
	<div id='kontener'>
		...
		<div id='glowny'>
			<hr>
			<h1>Serwis komputerów</h1>
			<p>Serwisujemy wszystkie rodzaje i&nbsp;typy pectetów, więc bez problemu zreperujemy i zmodernizujemy Twój komputer stacjonarny. Będziesz zaskoczony, jak wspaniale można go przyśpieszyć&nbsp;oraz udoskonalić. Spraw, aby praca na&nbsp;Twoim PC stała się przyjemnością i zobacz jakie wykonujemy naprawy!</p>
			<hr>
		</div>
		<div id='stopka'>
